...
import PhotoPreview from "./components/feed-view/PhotoPreview";
...
class App extends Component {
  ...
  setPanelFeed = (id) => {
    this.setState({ activePanelFeed: id })
  }

  showPhoto = (photo) => {
    this.setState({ photo: photo })
    this.setState({ activePanelFeed: 'photo' })
  }
      ...
      <div className="App">
        ...
        <Tabbar>
          ...
          <Root id="feed" activeView="feed">
            <View id="feed" activePanel={this.state.activePanelFeed} popout={this.state.popout} modal={modal}>
              <FeedView id="/feed" popout={this.state.popout}  user={this.state.fetchedUser} setActiveModal={this.setActiveModal} setPopout={this.setPopout} showPhoto={this.showPhoto}/>
              <PhotoPreview id="photo" photo={this.state.photo} setPanelFeed={this.setPanelFeed}/>
            </View>
          </Root>
        </Epic>
      </div>
